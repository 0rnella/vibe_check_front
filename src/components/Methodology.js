  ...
  return (
    <Fragment>
      ...
      <main>
        ...
        <p>
          All information on company lawsuits was acquired using the form 10-K, or annual reports, of each individual company. Info that was not available directly impacted the overall score for that particular category. All information obtained is based on records accessed from 2015-2019, with updates being made accordingly for more recent data.
        </p>
      </main>
    </Fragment>
  );
